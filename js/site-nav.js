/* =========================================================
   SITE-NAV.JS
   Cabecalho, menu movel (burger/overlay/close), classe de scroll
   do header, tecla Escape a fechar o menu, e o ano no rodape —
   comportamento identico em todas as paginas, antes duplicado em
   cada js/<pagina>.js.

   Porque isto tem de ser centralizado (e nao um script de pagina
   normal): os listeners de "scroll" e "keydown" tinham de ser
   anexados a window/document, que sobrevivem a cada navegacao SPA
   (o router so substitui document.body.innerHTML). Sendo cada
   js/<pagina>.js reinjectado e executado do zero a cada navegacao,
   isso registava um NOVO listener de scroll/keydown de cada vez,
   sem nunca remover o anterior — um memory leak real que se
   acumulava a cada troca de pagina. Este modulo corre uma unica
   vez (guarda "boundOnce") e volta apenas a ligar os elementos do
   menu (burger/overlay/close/links), que sao mesmo substituidos a
   cada navegacao.
   ========================================================= */
(function () {
  "use strict";
