/* =========================================================
   WIDGETS.JS
   Estrutura fixa no canto inferior direito, consistente em
   todas as paginas:
     [ idioma ]
     [ WhatsApp ]
   Construida uma unica vez e marcada [data-persist] — o router
   (spa-router.js) desanexa-a e reanexa-a a cada troca de pagina,
   em vez de a destruir e reconstruir (evita flicker e garante que
   nenhum listener fica duplicado). O numero de WhatsApp e a logica
   do icone replicam exactamente o botao "whatsapp-float" que
   existia no index.html original (antes apenas na Home).
   ========================================================= */
(function () {
  "use strict";

  var WHATSAPP_URL = "https://wa.me/258844150512";
