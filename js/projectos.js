...
(function(){
  /* FOTOS DE CADA PROJECTO — preencher a lista da respectiva "gallery-key"
     (proj-01 a proj-21). Pode ficar vazia []; a galeria só aparece se houver fotos. */
  ...
  /* CAPA DE CADA CARTÃO — preencher o caminho da respectiva "cover-key"
     (proj-01 a proj-21, igual à galeria acima). Vazio ("") mantém o visual decorativo. */
  ...
  /* PREVIEW (LIGHTBOX) das imagens da galeria — isolado a .proj-modal-gallery */
